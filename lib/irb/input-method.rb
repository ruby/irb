...
module IRB
  ...
  class ReadlineInputMethod < StdioInputMethod
    ...
    def initialize(completor:)
      ...
      Readline.completion_proc = completor.method(:complete)
    end
  ...
  class RelineInputMethod < StdioInputMethod
    ...
    def initialize(completor:)
      ...
      Reline.completion_proc = @completor.method(:complete)
      ...
      Reline.dig_perfect_match_proc = @completor.method(:display_doc)
      Reline.autocompletion = IRB.conf[:USE_AUTOCOMPLETE]

      if IRB.conf[:USE_AUTOCOMPLETE]
        begin
          require 'rdoc'
          Reline.add_dialog_proc(:show_doc, show_doc_proc, Reline::DEFAULT_DIALOG_CONTEXT)
        rescue LoadError
        end
      end
    end
    ...
    def show_doc_proc
      ...
      ->() {
        ...
        name = result[pointer]
        name = completor.retrieve_completion_data(name, doc_namespace: true)
